...
SimpleAggrExpression = name:SimpleAggrToken '(' _ attr:Identifier _ ')' {
    return {
...
ApdexExpression = name:ApdexToken '(' _ attr:Identifier _ ',' _ 't:' _ thresh:FloatLiteral _ ')' {
    return {
        type: "FunctionExpression",
        name: name[0],
...
CountExpression = name:CountToken '(' _ arg:(StarLiteral / Identifier) _ ')' {
    return {
        type: "FunctionExpression",
        name: name[0],
        arguments: [arg]
...
FilterExpression = name:FilterToken '(' expr:AggrExpression _ ',' _
                                        where:WhereClause _ ')' {
    return {
        type: "FunctionExpression",
        name: name[0],
...
FunnelExpression = name:FunnelToken '(' attr:Identifier _
...
HistogramExpression = name:HistogramToken '(' attr:Identifier _ ',' _
...
PercentageExpression = name:PercentageToken '(' expr:AggrExpression _ ',' _
                                                where:WhereClause _ ')' {
    return {
        type: "FunctionExpression",
        name: name[0],
...
PercentileExpression = name:PercentileToken '(' attr:Identifier _ percentiles:(',' _ FloatLiteral _)* ')' {
    var args = [attr];
...
SelectClause = call:AggrExpression _ label:(AsToken _ StringLiteral)? {
